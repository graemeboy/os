...
?>
	...
	echo '<p>';
	echo '<div><label><input type="radio" name="newskin_disable_mobile" value="show_large"';
	if (trim($this_skin['disable_mobile']) == 'show_large' || trim($this_skin['disable_mobile']) == 'yes') {
		echo 'checked="checked"';
	}
	echo '/> Only show on large or medium-sized devices</label></div>';
	echo '<div style="margin-top:10px;"><label><input type="radio" name="newskin_disable_mobile" value="show_small"';
	if (empty($this_skin['disable_mobile']) || 
		trim($this_skin['disable_mobile']) == 'show_small') {
		echo 'checked="checked"';
	}
	echo '/> Only show small devices</label></div>';
	echo '<div style="margin-top:10px;"><label><input type="radio" name="newskin_disable_mobile" value="show_all"';
