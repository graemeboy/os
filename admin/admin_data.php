...
<div class="ois_box_' . $id . ' container-fluid" style="' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . 'width:%box-width%!important; border-radius: %border-radius% !important; -moz-border-radius: %-webkit-border-radius% !important; %border-radius% !important; border-color: %border-color% !important;">
	...
	$skin_3 = array(
		...
		'html' => '<div class="ois_inner_wrap_' . $id . ' container-fluid" style="max-width:220px;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . '<div class="ois_' . $id . '" class="container-fluid">
	...
	$skin_5 = array (
		...
		'html' => '<div class="ois_box_' . $id . ' container-fluid" style="max-width:600px;border: 1px solid %outer-border-color% !important;background-color: %background-color% !important;">
	...
	$skin_6 = array(
		...
		'html' => '
<div class="ois_box_' . $id . ' container-fluid" style="max-width:520px;border-radius: %border-radius% !important; -moz-border-radius:%border-radius% !important; -webkit-border-radius: %border-radius% !important;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . '">
	<div class="row-fluid">
		<div class="span7">
	...
	$skin_7 = array(
		...
		'date_added' => date('Y-m-d H:i:s'),
		'last_modified' => date('Y-m-d H:i:s'),
		'html' => '<div class="ois_box_' . $id . ' container-fluid" style="max-width:230px;background-color: %background-color% !important; border: 1px solid %border-color% !important;">
	...
	$skin_8 = array(
		...
		'html' => '
<div class="ois_box_' . $id . ' container-fluid" style="max-width:600px;background-color: %background-color% !important; border-radius: %border-radius% !important; -moz-border-radius: %border-radius% !important; -webkit-border-radius: %border-radius% !important; border-width: %border-width% !important; border-style: %border-style% !important; border-color: %border-color% !important;">
	<div class="row-fluid">
		<div class="span7">
	...
	$skin_10 = array (
		...
		'html' => '
		<div class="ois_' . $id . '" class="container-fluid" style="max-width:350px;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . '">
...
<div style="clear:both;"></div>
	...
	$skin_11 = array (
		...
		'html' => '<div class="ois_box_' . $id . '" style="max-width:600px;">
...
<div class="container-fluid" style="max-width:600px;">
	...
	$skin_13 = array (
		...
		'html' => '
		<div class="ois_box_' . $id . ' container-fluid" style="max-width:600px;">
	...
	$skin_14 = array (
		...
		'enable_name' => 'yes',
		'html' => '
<div class="ois_box_' . $id . ' container-fluid" style="max-width:650px;">
	...
	$skin_16 = array (
		...
		'html' => '
<div class="ois_outer_' . $id . '" style="max-width:600px;">
...
<div style="width:%box-width% !important;border-radius: %border-radius% !important; -moz-border-radius: %-webkit-border-radius% !important; %border-radius% !important;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . ' border: 1px %border-style% %border-color% !important; padding: %padding-top% 0 %padding-top% %padding-left% !important;">
	<div class="row-fluid">
		...
		<div class="span5" style="padding-top:5px!important;">
			<div style="font-size:%text-size% !important;font-family:%text-font% !important;line-height:normal !important;color: %heading-color% !important;padding-left: %heading-space-left% !important;">%title-text%</div>
		</div>
		<div class="span5">
			<div class="span4">
	...
	<div class="row-fluid">
		...
		<div class="span5" style="padding-top:5px!important;">
			<div style="font-size:%text-size% !important;font-family:%text-font% !important;line-height:normal !important;color: %heading-color% !important;padding-left: %heading-space-left% !important;">%subtitle-text%</div>
		</div>
		<div class="span5">
			%optin_form%
		</div>
		...
		'appearance' => array (
			'text' => array (
				...
				'Text 1' => ois_title_text('Share the Love'),
				'Text 2' => ois_subtitle_text('Get Free Updates'),
				'Border Style' => array (
					'attr' => 'border-style',
					'default' => 'solid',
					'values' => array (
	...
	$skin_18 = array (
		...
		'html' => '
<div class="ois_outer_18 container-fluid" style="max-width:450px; border:1px solid %border-color% !important;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . '">
	...
	$skin_19 = array (
		...
		'html' => '<div class="ois_box_19 container-fluid" style="max-width:240px;' . ois_vertical_gradient('%background-top-gradient%', '%background-bottom-gradient%') . 'border: 1px solid %border-color% !important;">
            	<div class="row-fluid">
            		<div class="span8">
	...
	$skin_20 = array (
		...
		'html' => '
		<div class="ois_' . $id . '" style="max-width:660px;">
			<div class="row-fluid">
				<div class="span7">
	...
	$skin_21 = array(
		...
		'design_preview' => OptinSkin_URL . 'admin/images/design_previews/21.png',
		'html' => '
		<div class="ois_inner_wrap_' . $id . ' container-fluid" style="max-width:220px;background-color:%background-color%!important;border: 1px solid %border-color%!important;">
			<div class="ois_' . $id . '" class="container-fluid">
				<div class="ois_inner_' . $id . '">
					<div class="ois_title_' . $id . '" style="color:%title-color% !important;">
						%title-text%
					</div>
					<div class="ois_subtitle_' . $id . '" style="color:%subtitle-color% !important;">
						%subtitle%
					</div>
					%optin_form%
				</div>
		...
		'css' => '',
		'css_url' => OptinSkin_URL . 'skins/css/design_22.css',
		'appearance' => array (
			'text' => array (
				'Background Color' => ois_color_option ( 'background-color', '#ecf0f1' ),
				'Border Color' => ois_color_option ( 'border-color', '#d7e0e2' ),
				'Title Color' => ois_color_option( 'title-color', '#2c3e50' ),
				'Subtitle Color' => ois_color_option( 'subtitle-color', '#2c3e50' ),
				'Title' => ois_title_text('Stay in touch'),
				'Subtitle' => array(
					'attr' => 'subtitle',
					'default' => 'Sign up for free updates',
	...
	$designs = array( '1' => $skin_1, '2' => $skin_15, '3' => $skin_3, '4' => $skin_4, '5' => $skin_5, '6' => $skin_6, '7' => $skin_7, '8' => $skin_8, '9' => $skin_9, '10' => $skin_10, '11' => $skin_11, '12' => $skin_12, '13' => $skin_13, '14' => $skin_14, '15' => $skin_2, '16' => $skin_16, '17' => $skin_17, '18' => $skin_18, '19' => $skin_19, '20' => $skin_20, '21' => $skin_21 );

	// which ones get added to the actual set?
	$included_designs = array( 
	 '1' => $skin_20, '2' => $skin_1, '3' => $skin_3, '4' => $skin_4, '5' => $skin_5, '6' => $skin_13, '7' => $skin_14, '8' => $skin_16, '9' => $skin_21  );
